...
\usepackage{graphicx, amsmath, mathtools}			% Inclusão de gráficos
\usepackage{lipsum, url}				% para geração de dummy text
\usepackage[alf,versalete,abnt-emphasize = bf]{abntex2cite}
% destaca o titulo da revista ou livro em negrito;
...
\usepackage{setspace} 
\usepackage{substr}
%\newcommand{\assinaturaII}[1]{
%   \begingroup\par\centering\parbox[t]{14.2cm}{\onehalfspacing\vspace*{0.7cm}\centering\rule{15cm}{1pt}\\ 
%   \nopagebreak #1\par}\par\endgroup
%}
\newcommand{\assinaturaII}[1]{
   \begingroup\par\centering\parbox[t]{\textwidth}{\vspace*{0.7cm}\centering\rule{\textwidth}{1pt}\\ 
   \nopagebreak #1\par}\par\endgroup
}
% ----------------------------------------------------------
...
\input{ElementosPreTextuais/acronimos}
...
\input{ElementosPosTextuais/glossario}
\input{seusPackages}
...
\input{ElementosPreTextuais/ficha}
%\input{ElementosPreTextuais/ata_defesa}
\input{ElementosPreTextuais/folha_aprovacao_original}
